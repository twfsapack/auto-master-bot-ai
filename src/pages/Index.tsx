    ...
    <div className="min-h-screen gradient-bg flex flex-col items-center relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full px-4 sm:px-6 lg:px-8 relative z-10 safe-area-top safe-area-bottom">
        <div className="w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8">
          <div className="flex flex-col items-center space-y-6 sm:space-y-8 animate-fade-in-up">
            {/* Logo Container */}
            ...
            <div className="flex flex-col items-center animate-fade-in-up" style={{animationDelay: '0.4s'}}>
              <p className="text-xs sm:text-sm text-purple-300 mt-2 italic opacity-80 text-center">
                powered by Trucktruest.com
              </p>
            </div>
            
            <p className="text-xs sm:text-sm text-center text-white/80 animate-fade-in-up max-w-sm px-4" style={{animationDelay: '0.6s'}}>
              PARA INTERACTUAR CON LA APLICACIÓN<br />
              NECESITAS INICIAR SESIÓN
            </p>
          </div>

          <div className="space-y-3 sm:space-y-4 animate-fade-in-up px-4 sm:px-0" style={{animationDelay: '0.8s'}}>
            ...
            >
              <div className="flex items-center justify-center space-x-3">
                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-white/20 rounded-full p-1 flex items-center justify-center backdrop-blur">
                  <Mail className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                </div>
                <span className="text-sm sm:text-base">INICIAR SESIÓN CON EMAIL</span>
              </div>
            </Button>
            ...
            <div className="space-y-3 opacity-50">
              <Button
                disabled
                className="w-full h-10 sm:h-12 bg-white/5 border border-white/20 rounded-xl text-white/60 font-medium backdrop-blur transition-all duration-300 cursor-not-allowed"
              >
                <div className="flex items-center justify-center space-x-3">
              ...
              >
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <span className="text-xs sm:text-sm">INICIAR SESIÓN CON APPLE</span>
                </div>
              </Button>
            </div>
          ...
          <div className="text-center pt-2 sm:pt-4 animate-fade-in-up px-4" style={{animationDelay: '1s'}}>
