      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full px-4 animate-fade-in">
        <div className="w-full max-w-md space-y-8">
          <div className="flex flex-col items-center space-y-6 animate-slide-down">
            {/* Logo Principal */}
            <div className="w-40 h-40 -mt-10 rounded-full flex items-center justify-center shadow-elevated animate-scale-in animate-logo-glow">
              <img 
                src="/logo.png" 
                ...
                onError={(e) => {
                  ...
                  e.currentTarget.parentElement!.classList.add('logo-gradient');
                }}
              />
            </div>
            ...
            <p className="text-sm text-center text-logo-secondary mb-8 animate-fade-in max-w-sm">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="w-full h-14 bg-gradient-to-r from-logo-primary to-logo-accent hover:from-logo-secondary hover:to-logo-primary rounded-xl transition-all duration-300 transform hover:scale-105 animate-slide-up shadow-elevated border border-logo-primary/20"
            >
